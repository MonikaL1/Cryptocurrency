...
# Krijimi i një adrese ne nyjen Port 5001
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Monika', amount = 1)
...
def add_transaction():
    ...
    if not all(key in json for key in transaction_keys):
        return 'Mungojne disa elemente te transaksionit', 400
    index = blockchain.add_transaction(json['sender'], json['receiver'], json['amount'])
    response = {'message': f'Transaksioni do shtohet ne bllok {index}'}
